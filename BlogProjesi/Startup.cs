...
namespace BlogProjesi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BlogContext>(x => x.UseSqlServer(Configuration.GetConnectionString("Baglanti")));
            services.AddScoped<MakaleModel>();
            services.AddScoped<Makaleler>();
